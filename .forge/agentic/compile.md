...
- Read: `docs/plans/active/FRG-XXXX/brief.md` — the human's goal
- Read: `docs/plans/active/FRG-XXXX/git_history.txt` — generated by Fetch
- Read: `db/schema.rb` — real tables and columns for Domain Map
- Read: `lib/**/*.rb` — existing source patterns
- Read: `spec/**/*.rb` — existing test conventions
- Read: `docs/plans/.template/contract.md` — contract structure to follow
